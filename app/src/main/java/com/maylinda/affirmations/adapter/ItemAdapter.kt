// TODO 3a: Langkah ketiga bagian pertama untuk dapat membuat Affirmation Recyclerview yakni tahap adapter,
//  membuat sebuah package dengan nama adapter,melalui:meng-klik kanan app > java > com.maylinda.affirmations,
//  lalu pilih New > Package > com.maylinda.affirmations.adapter>enter.
//  Dalam package adapter dibuat class bernama ItemAdapter dengan cara :klik kanan paket com.maylinda.affirmations.adapter
//  dan pilih New > Kotlin File/Class > ItemAdapter.kt > enter.
package com.maylinda.affirmations.adapter
